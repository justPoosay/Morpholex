...
export const TransformWordBody = zod.object({
  "word": zod.string().min(1).max(transformWordBodyWordMax).describe('The English word in its primary form')
})

export const TransformWordResponse = zod.object({
  "originalWord": zod.string(),
  "groups": zod.array(zod.object({
  "category": zod.string().describe('The grammatical or morphological category (e.g. \"Adjectives\", \"Adverbs\", \"Verb forms\", \"Nouns\")'),
